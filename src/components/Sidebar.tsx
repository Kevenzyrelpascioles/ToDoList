  ...
  return (
    <Container>
      ...
      >
        ...
        <MenuLink to="https://github.com/Kevenzyrelpascioles">
        ...
        <MenuLink to="https://www.facebook.com/ailen.lagarto">
              ...
              onClick={() => {
                showToast(
                  <div style={{ display: "inline-block" }}>
                    To install the app on iOS/Android Safari, click on{" "}
        ...
        <ProfileOptionsBottom>
          ...
          <CreditsContainer translate="no">
            ...
            <a
              ...
              href="https://github.com/Kevenzyrelpascioles"
            >
              Keven
            </a>
          </CreditsContainer>
